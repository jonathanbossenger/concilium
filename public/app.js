  ...
  async checkGitHub() {
    ...
    try {
      ...
      if (data.url) {
        ...
        this.githubBtn.title = 'Browse GitHub issues and pull requests';
        this.githubBtn.setAttribute('aria-label', 'Browse GitHub issues and pull requests');
        this.githubBtn.hidden = false;
      } else {
        this.githubUrl = '';
        this.githubBtn.title = 'Create GitHub repository';
        this.githubBtn.setAttribute('aria-label', 'Create GitHub repository');
        this.githubBtn.hidden = false;
      }
    } catch (err) {
